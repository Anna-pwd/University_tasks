...
<header>
	...
	<article>
		<section>
			<?php 
				echo '<header><h1>Jak do nas dotrzeć</h1></header>';
				echo $linkmaps;
			?>	
		</section>
	</article>	
			...
			<?
				if ($_SESSION['loggedin']){		
					echo '<header><h1>Zarządzanie zawartością strony</h1></header>
						<form method="post" action="zarzadzanie.php" name="linkmaps">
							Tekst strony:
							<br>
							<textarea id="tekst" name="linkmaps" style="width: 500px; height: 200px;">';
							echo $linkmaps;
							echo '</textarea><br>
