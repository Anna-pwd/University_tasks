<?php
	...
	$result = mysqli_query($polaczenie, "SELECT * FROM `szkoleniowcy` WHERE `login`='$login'");
	...
	if ($ile>0){
		...
		if($haslo!=$haslo2){
			...
			mysqli_query($polaczenie, "INSERT INTO `szkoleniowcy` (`login`, `haslo`) VALUES ('$login', '$haslo')") or die ("Błąd zapytania do bazy result: $dbname");
